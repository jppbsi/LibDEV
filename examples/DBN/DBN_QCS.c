...
int main(int argc, char **argv){
    ...
    if (CheckSearchSpace(s, _CS_)) /* It checks whether the search space is valid or not */
        runTensorCS(s, _QUATERNION_, Bernoulli_BernoulliDBN4Reconstruction, Train, op, n_layers, n_epochs, batch_size, n_gibbs_sampling, eta_bound); /* It minimizes function Sphere */
