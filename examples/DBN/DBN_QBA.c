...
int main(int argc, char **argv){
    ...
    s = ReadSearchSpaceFromFile(argv[5], _BA_);
    ...
    fprintf(stderr,"\nRunning BA ... ");
    if (CheckSearchSpace(s, _BA_)) /* It checks whether the search space is valid or not */
        runTensorBA(s, _QUATERNION_, Bernoulli_BernoulliDBN4Reconstruction, Train, op, n_layers, n_epochs, batch_size, n_gibbs_sampling, eta_bound); /* It minimizes function Sphere */
