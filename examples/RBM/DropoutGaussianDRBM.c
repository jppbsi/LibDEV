...
int main(int argc, char **argv){
    ...
    fprintf(stderr,"\nRunning PSO ... ");
    runPSO(s, Gaussian_BernoulliDRBMWithDropout, Train, n_epochs, batch_size, n_gibbs_sampling, sigma, eta_bound);
    ...
    errorTrain = DiscriminativeGaussianBernoulliRBMTrainingbyContrastiveDivergencewithDropout(DatasetTrain, m, n_epochs, n_gibbs_sampling, batch_size, p);
