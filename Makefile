...
all: libdev OPFknn OPFcluster DBN DropoutDBN DropconnectDBN DBM FeatureSelection DRBM DropoutDRBM GaussianDRBM DropoutGaussianDRBM LinearRegression LogisticRegression
